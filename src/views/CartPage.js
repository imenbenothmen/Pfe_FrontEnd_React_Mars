...
import IndexNavbar from "components/Navbars/IndexNavbar.js"; // Import de la navbar
import Footer from "components/Footers/Footer.js"; // Import du footer
...
export default function CartPage() {
  ...
  // Fonction pour ajouter un produit fictif au panier (peut être ajustée pour des produits réels)
  const addToCart = () => {
  ...
  return (
    <>
      ...
      <main className="flex flex-col min-h-screen">
              ...
              <div className="space-y-6">
                <ul className="space-y-4">
                  {cart.map((product, index) => (
                    <li key={index} className="flex justify-between items-center p-4 bg-white shadow-md rounded-lg hover:shadow-lg transition-all duration-200">
                ...
                <div className="mt-8 flex justify-between items-center">
                  <h3 className="text-xl font-semibold text-blueGray-700">Total: {getTotalPrice()} TND</h3>
        ...
        <Footer className="mt-auto" /> {/* Footer en bas avec marge automatique */}
      </main>
    </>
  );
}
