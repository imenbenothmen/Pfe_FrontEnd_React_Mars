  ...
  return (
    <>
      ...
      <section className="relative bg-pink-100 pt-32 pb-20 flex items-center justify-center text-center">
        ...
        <div className="relative z-10 max-w-3xl">
          ...
          <p className="text-lg text-gray-700 mb-6">
            Des bijoux qui racontent votre histoire – Élégance, féminité et
            force.
          </p>
          <Link
            to="/landing"
            className="bg-yellow-500 hover:bg-yellow-600 text-white px-8 py-3 rounded-full text-sm font-bold uppercase"
          >
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-wrap justify-center gap-8">
            {[
              ...
              <div
                key={i}
                className="w-full md:w-1/4 text-center bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition"
              >
            ...
            {["Colliers", "Bracelets", "Boucles", "Bagues", "Montres"].map(
              (cat, i) => (
                <Link
                  ...
                  className="bg-white w-40 py-6 px-4 rounded shadow hover:shadow-lg transition duration-300 transform hover:scale-105"
                >
      ...
      <section className="py-16 bg-yellow-100 text-center">
        ...
        <Link
          to="/shop"
          className="mt-6 inline-block bg-yellow-500 text-white px-6 py-3 rounded-full font-bold uppercase text-sm"
        >
          Voir les bijoux
        </Link>
      </section>
